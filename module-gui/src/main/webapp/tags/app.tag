<app>
	...
	<script>
		...
		this.on("mount", () => {
		    ...
		    $.ajax( {
			        url: "/workflow/api/plugins/ocrselector/" + this.generalOpts.processId + "/dd",
			        type: "GET",
			        datatype: "JSON"
			    }).then(function(data) {
		    ...
		    fetch(`/workflow/api/messages/${this.generalOpts.language}`, {
                  method: 'GET',
		...
		getSavedData() {
		    $.ajax( {
		        url: "/workflow/api/plugins/ocrselector/" + this.generalOpts.processId + "/saved",
			        type: "GET",
			        datatype: "JSON"
		    }).then(function(data) {
		        if(data.savedData) {
		...
		save() {
			...
			return $.ajax({
				url: "/workflow/api/plugins/ocrselector/" + this.generalOpts.processId + "/results",
				type:"POST",
